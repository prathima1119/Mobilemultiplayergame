...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public GameObject JoinRandom_UI_Panel;
   ...
   private void Update()
    ...
    public void OnJointRandomRoomButtonClicked()
    {
        ActivatePanel(JoinRandom_UI_Panel.name);
    ...
    public override void OnJoinedRoom()
    {
        ...
        //instantiating player list game objects
    ...
    public void ActivatePanel(string panelToBeActivated)
    {
        ...
        JoinRandom_UI_Panel.SetActive(panelToBeActivated.Equals(JoinRandom_UI_Panel.name));
